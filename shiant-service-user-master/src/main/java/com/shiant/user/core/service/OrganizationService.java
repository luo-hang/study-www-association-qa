...
public interface OrganizationService {
	 ...
	 * @throws ServiceException
	 */
	Organization findByid(Long id,UserRmiVo user) throws ServiceException;
	
	/**
	 * <p> @方法描述：    根据名称获取组织机构			</p>
	 * <p> @创建人：        AkatsukiSimo Xie		</p>
	 * <p> @创建时间：    2020年8月7日 下午10:01:13	</p>
	 * <p> @修改人：        AkatsukiSimo Xie		</p>
	 * <p> @修改时间：    2020年8月7日 下午10:01:13	</p>
	 * @param orgName	组织机构名称
	 * @param user		用户信息
	 * @return
	 */
	Organization findByName(String orgName, UserRmiVo user) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	Organization addBean(OrganizationRmiVo bean,UserRmiVo user) throws ServiceException;
	 ...
	 */
	Map<String, Object> getBeans(int from, int size, List<Long> orgids, String province, Date startYear,
			Date endYear) throws ServiceException;
