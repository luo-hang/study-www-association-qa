...
CREATE TABLE `t_sys_professional` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `professional` varchar(255) NOT NULL COMMENT '专业名称',
  `college` varchar(255) NOT NULL COMMENT '所属学院',
  `degree` varchar(255) NOT NULL COMMENT '毕业学位',
  `advantage` varchar(20) NOT NULL COMMENT '是否优势专业',
  `semester` int(11) NOT NULL COMMENT '学期(月)',
  `tuition` bigint(20) NOT NULL COMMENT '学费(￥)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
