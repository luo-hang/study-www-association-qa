package com.shiant.study.core.legal.dao.impl;
...
public class ComplaintDaoImpl implements ComplaintDao {
	...
	@Override
	public List<Complaint> getBeans(int from, int size, Long orgid, String creater, String title, String orgName,
		...
		try{
			...
			List<Complaint> beans = query.getResultList();
			return beans;
		}catch(Exception e){
